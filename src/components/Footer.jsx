...
const Footer = () => {
  ...
  const FooterLinkColumn = ({ title, items }) => (
    <div className="footer-column">
      <h4 className="font-semibold text-[#170F49] text-[20px] mb-4">
        {title}
      </h4>
      <ul className="space-y-3">
        {items.map((link) => (
          <li key={link}>
            <a
              href="#"
              className="block text-[#6F6C90] text-[15px] transition hover:text-[#B58718] hover:translate-x-2"
            >
              {link}
            </a>
          </li>
  ...
  return (
    <footer
      ref={containerRef}
      className="bg-white text-gray-800 pb-12 font-sans overflow-hidden"
    >
      ...
      >
        {/* TOP */}
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 my-12">
          <div className="footer-top-content text-4xl font-bold text-[#170F49]">
            Logo
          </div>
      ...
      {/* 🎯 SAME 87vw WRAPPER */}
      <div
        className="mx-auto w-full px-4 lg:px-0 mt-16"
        style={{ maxWidth: "87vw" }}
      >
        {/* MIDDLE */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="footer-column col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <form className="flex flex-col space-y-3">
              ...
              <button
                type="submit"
                className="group flex items-center justify-center gap-2 w-1/2 bg-[#B58718] text-white font-semibold px-4 py-3 rounded-full hover:bg-amber-700 transition shadow-md hover:shadow-lg"
              >
                Submit
                <ArrowRight
                  size={18}
        ...
        <div className="footer-bottom border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500">
          <p className="text-sm mb-4 md:mb-0 font-montserrat lg:text-[16px]">
