...
const MoreFAQ = () => {
  ...
  useGSAP(() => {
    gsap.timeline({
      ...
      .from(".accordion-item", { y: 20, opacity: 0, stagger: 0.1 }, "-=0.5");
  }, { scope: containerRef });
  ...
  const faqs = [
    ...
    {
      question: "How do you ensure your products/services are environmentally friendly?",
      answer:
  ...
  return (
    <section ref={containerRef} className="bg-white py-12 lg:py-24 overflow-hidden">
      <div className="max-w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        ...
        <div className="flex justify-end">
          <div className="faq-image-wrapper rounded-xl overflow-hidden shadow-xl lg:w-[38vw] w-[90vw] h-[45vh] lg:h-[70vh]">
            <img
