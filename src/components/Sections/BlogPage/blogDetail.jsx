      ...
      <div className="bg-white py-20 lg:py-24">
        <article className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <h1 className="font-times font-bold text-gray-900 mb-4 tracking-tight text-2xl lg:text-[4vmax] leading-tight">
              Insights, Tips & Property Advice{" "}
              <span className="hidden lg:flex"></span>
              From GFS Realtors
            </h1>
            <div className="flex justify-center items-center text-gray-500 text-md lg:text-lg">
        ...
        */}
          <div className="max-w-4xl mx-auto text-[#0A0A0ACC] font-montserrat leading-relaxed">
            {/* Paragraph 1 */}
            <p className="mb-6 ">
            ...
            <h2 className="text-center font-semibold text-[#0A0A0A] font-montserrat text-xl px-2 sm:px-20 lg:px-32 leading-normal mb-8">
            ...
            <h2
              className="font-semibold font-serif text-xl lg:text-3xl text-gray-900 mt-12 mb-6"
              style={{ fontSize: "2rem" }}
            >
            ...
            <p className="py-2 mb-10">
              <span className="font-semibold">Columns:</span> Columns take up
              most of the real estate in a grid. Elements and content are placed
              in columns. To adapt to any screen size, column widths are
              ...
              device might have 4 columns and a grid on a desktop might have 12
              columns.
            </p>

            {/* Exterior House Image */}
            <img
              className="rounded-xl shadow-md my-8 mx-auto w-full h-[45vh] lg:h-auto"
              style={{
                maxHeight: "350px",
                maxWidth: "900px",
                display: "block",
            ...
            <h2 className="my-5 text-2xl font-semibold text-[#0A0A0ACC]">
            ...
            <p className="mb-10">
              ...
              <span className="font-semibold">The New York Times</span>. This
              screen utilizes a hierarchical grid to create a newspaper-like
              reading experience. At desktop screen size, two main columns make
              up the hierarchical grid. The most important news story takes up
              the most space in the grid, the left column, followed by secondary
              and tertiary stories, which take up the smaller column and modules
              on the right.
            </p>
          </div>
